...
public class LoginActivity extends AppCompatActivity {
    ...
    private static final String DUMMY_USERNAME = "jesuloluwa";
    private static final String DUMMY_PASSWORD = "mypassword";
    private static final String[] DUMMY_USER = {"jileyitayo:eyitayo", DUMMY_USERNAME+ ":" + DUMMY_PASSWORD};
     /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView mUserSignUpMessage = (TextView) findViewById(R.id.tvLoginMessage);
        ...
        mUserSignUpMessage.setOnClickListener(new OnClickListener() {
            @Override
...
*/
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            user = sqLiteDbAdapter.getLoginData(mUsername, mPassword);
            ...
            /*
            for (String credential : DUMMY_USER) {
